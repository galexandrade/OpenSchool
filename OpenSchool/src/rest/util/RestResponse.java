...
/**
 * 
 * Pojo class representing the rest response. Contains all attributes necessary
 * to build the rest API response
 * <p>
 * See {@link RestResponseWriter} for details of how the JSON object is
 * build
 * <p>
 * DO NOT create an instance of this class neither use any set method directly.
 * To do that, please use {@link RestResponseBuilder}
 * 
